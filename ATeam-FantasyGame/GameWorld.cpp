...
void GameWorld::init(Player& player) {
    ...
    lake1 = new Location("Lake", "Now subdued, the kelpie bends its head, as if inviting you on its back as a way reaching your next destination.");
    crossedLake = new Location("Edge of the lake", "The Kelpie is lending its back to you as a way to cross the gloomy lake. In the distance you notice land that fits the description of Aine's domain. \nAs if reading your mind, the kelpie starts swimming across the lake as soon as you sit on it.\nYou are now on the other side of the lake.");
